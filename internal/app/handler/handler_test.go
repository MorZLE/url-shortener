...
//	//t2, _ = json.Marshal(&constjson.URLLong{URL: "https://vk.com/456gdjft"})
...
//			}
//
//			tt.args.r.Header.Set("Content-Encoding", "gzip, deflate")
...
//			r.ServeHTTP(tt.args.w, tt.args.r)
//
//			tt.args.w.Header().Set("Content-Encoding", "gzip")
//
